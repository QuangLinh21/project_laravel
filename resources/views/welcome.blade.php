						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							<div class="panel panel-default">
								...
								<div class="panel-heading">
									<h4 class="panel-title"><a href="{{URL::to('category-product-user/'.$cate->category_id)}}">{{$cate->category_name}}</a></h4>
								</div>
								@endforeach
							</div>
						...
						<div class="brands_products"><!--brands_products-->
							...
							<div class="brands-name">
								...
								<ul class="nav nav-pills nav-stacked">
									<li><a href="{{URL::to('brand-product-user/'.$brand->brand_id)}}">{{$brand->brand_name}}</a></li>
								</ul>
								@endforeach
							</div>
						</div>
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					...
					<p class="pull-right">Designed by Nguyễn Quang Linh</span></p>
				</div>
			</div>
		</div>
