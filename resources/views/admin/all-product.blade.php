            ...
            <table class="table table-striped b-t b-light">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><img src="../public/uploads/product/{{$product->product_image}}" width="100px" height="110px" alt=""></td>
                        ...
                        <td>
                            <a href="{{URL::to('delete-product/'.$product->product_id)}}" class="active" ui-toggle-class="" onclick="return confirm('Bạn có muốn xóa danh mục này không?')"><i class="fa fa-times text-danger text"></i></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
