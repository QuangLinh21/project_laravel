                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="cart_quantity">
                            <div class="cart_quantity_button">
                               <form action="{{URL::to('update-cart-quantity')}}" method="POST">
                                {{ csrf_field() }}               
									<input type="number"class="cart_quantity_input" style="width:40px; border: 2px solid #E6E4DF; margin:-5px 5px 0 0"  name="cart_quantity" value="{{$val['product_qty']}}"  min="1" >
									{{-- <input class="cart_quantity_input" type="text" name="cart_quantity" value="{{$v_content->qty}}"  min="1" size="2"> --}}
									<input type="hidden" name="rowId_cart" id="" class="" value="">
                        ...
                        <td class="cart_delete">
                            <a class="cart_quantity_delete"  href="{{URL::to('delete-to-cart')}}" ><i class="fa fa-times" style="margin-top:50px;"></i></a>
                        </td>
                    </tr>
					@endforeach
                </tbody>
