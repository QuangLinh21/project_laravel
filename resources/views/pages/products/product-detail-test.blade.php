...
<div class="recommended_items"><!--recommended_items-->
    ...
    <div id="recommended-item-carousel" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="item active">
                @foreach($related as $key=>$splienquan)
                <div class="col-sm-4">
                    <div class="product-image-wrapper">
                        <div class="single-products">
                            <div class="productinfo text-center">
                                <img src="{{URL::to('../public/uploads/product/'.$splienquan->product_image)}}" width="80px" height="230px" alt="" />
                                <h2>{{$splienquan->product_price}}</h2>
                                <p>{{$splienquan->product_name}}</p>
                                <a href="{{URL::to('product-details/'.$splienquan->product_id)}}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Thêm giỏ hàng</a>
                            </div>
                        </div>
                    </div>
                </div>
